...
fwabc is an R package to read data from BC Freshwater Atlas geodatabases.

By providing a GnisName, BlueLineKey and/or WatershedGroup (depending on the layers you are accessing), we then write the SQL select queries to get a subset of the data into memory.
